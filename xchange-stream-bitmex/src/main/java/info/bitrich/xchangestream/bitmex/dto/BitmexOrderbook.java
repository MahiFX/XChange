...
public class BitmexOrderbook {
    private final SortedMap<BigDecimal, BitmexLimitOrder> asks;
    private final SortedMap<BigDecimal, BitmexLimitOrder> bids;

    private final Map<String, BigDecimal> askIds;
    private final Map<String, BigDecimal> bidIds;
    ...
    public BitmexLimitOrder[] getLevels(String side) {
        ...
        return orderBookSide.values().toArray(new BitmexLimitOrder[0]);
    }
