...
public class BitmexOrderReplaceTest {
    ...
    public void testOrderReplace() throws Exception {
        ...
        BitmexExchange exchange =
                ExchangeFactory.INSTANCE.createExchange(BitmexExchange.class);
...
//        defaultExchangeSpecification.setProxyPort(9999);
        ...
        BigDecimal originalOrderSize = new BigDecimal("100");
        //    BigDecimal price = new BigDecimal("10000");
        BigDecimal price = orderBook.getBids().get(0).getLimitPrice().add(new BigDecimal("100000"));
        ...
        System.out.println("openPositions = " + openPositions);
