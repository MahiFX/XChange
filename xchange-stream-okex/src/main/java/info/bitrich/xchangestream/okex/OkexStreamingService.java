...
public class OkexStreamingService extends JsonNettyStreamingService {
  ...
  public static final String ORDERBOOK400 = "books-l2-tbt";
  public static final String ORDERBOOK_TOB = "bbo-tbt";
  ...
  private OkexSubscribeMessage.SubscriptionTopic getTopic(String channelName) {
    String[] channelAndInstrument = channelName.split(":");
    if (channelAndInstrument.length == 2) {
      return new OkexSubscribeMessage.SubscriptionTopic(channelAndInstrument[0], null, null, channelAndInstrument[1]);
    } else {
